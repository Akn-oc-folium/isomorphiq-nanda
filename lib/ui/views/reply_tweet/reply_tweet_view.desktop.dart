...
class ReplyTweetViewDesktop extends ViewModelWidget<ReplyTweetViewModel> {
  ...
  Widget buildReplyPanel(ReplyTweetViewModel viewModel) {
    ...
    if (selectedTweet.id.isEmpty) {
      return Container(); // Return empty if no tweet selected
    }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /// Row: refresh icon + generate button
                Row(
                  children: [
                    /// Refresh icon (disabled here for example)
                    Container(
                      width: 48.w,
                      height: 48.w,
  ...
  /// Build modify accounts right panel
  ...
  /// Helper to build category chips section
